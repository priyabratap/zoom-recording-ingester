    ...
    def __init__(self, scope: core.Construct, id: str,
        ...
        on_demand = ZipOnDemandFunction(self, "OnDemandFunction",
            ...
            environment={
                ...
                "PIPELINE_STATUS_TABLE": status.table.table_name
            }
        )

        # grant on demand function permissions
        status.table.grant_read_write_data(on_demand.function)
        ...
        status.table.grant_read_write_data(webhook.function)
        ...
        status.table.grant_read_write_data(downloader.function)
        ...
        status.table.grant_read_write_data(uploader.function)
